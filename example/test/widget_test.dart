...
void main() {
  group('SpaceExtension', () {
    ...
    test(
      'spaceXY should return a SizedBox with specified width and height',
      () {
    ...
    test(
      'spXY getter should return a SizedBox with specified width and height',
      () {
  ...
  group('TextExtension', () {
    test(
      'edit function should return a Text widget with specified properties',
      () {
  ...
  group('CustomImageExtension', () {
    test(
      'img function should return an Image widget with specified properties',
      () {
  ...
  group('Conditional Function', () {
    test(
      'condition function should return correct value based on condition',
      () {
    ...
    test(
      'conditionFunction should invoke correct function based on condition',
      () {
